...
Url {
  protocol: 'https:',
    ...
    hash: null,
    search: '?name%3Dzhangsan%26age%3D12%23comment',
    query: 'name%3Dzhangsan%26age%3D12%23comment',
    pathname: '/path',
    path: '/path?name%3Dzhangsan%26age%3D12%23comment',
    href: 'https://www.baidu.com:80/path?name%3Dzhangsan%26age%3D12%23comment'
}
...
Url {
  ...
  hash: null,
  search: '?name%3Dzhangsan%26age%3D12%23comment',
  query: [Object: null prototype] { 'name=zhangsan&age=12#comment': '' },
  pathname: '/path',
  path: '/path?name%3Dzhangsan%26age%3D12%23comment',
  href: 'https://www.baidu.com:80/path?name%3Dzhangsan%26age%3D12%23comment'
}
